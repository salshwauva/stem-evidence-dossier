...
def test_work_id_is_stable_for_the_same_source_identity() -> None:
    ...
    assert make_work_id("pmid", "12345678") == "work_4f4402cd240d30fe"


def test_work_id_depends_on_the_identifier_scheme() -> None:
    # sha256("arxiv:2401.01234") starts with 862e86582f0a447a.
    assert make_work_id("arxiv", "2401.01234") == "work_862e86582f0a447a"
